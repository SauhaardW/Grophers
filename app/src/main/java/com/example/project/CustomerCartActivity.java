...
public class CustomerCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.child("customers").child(uid).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                list.clear();
                String store_id = snapshot.child("curCartStoreId").getValue(String.class);
                String customerName = snapshot.child("username").getValue(String.class);
